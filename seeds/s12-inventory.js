...
exports.seed = async function(knex) {
    ...
    await knex('Inventory').insert([
      { idKho: 1, idLaptop: 1, soLuong: 3, viTriKho: 'A1' },
      { idKho: 1, idLaptop: 2, soLuong: 3, viTriKho: 'A1' },
      { idKho: 1, idLaptop: 3, soLuong: 1, viTriKho: 'A2' },
      ...
      { idKho: 3, idLaptop: 1, soLuong: 4, viTriKho: 'C1' },
